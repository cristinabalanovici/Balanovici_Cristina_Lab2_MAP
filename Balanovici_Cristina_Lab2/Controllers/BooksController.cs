...
using Balanovici_Cristina_Lab2.Data;
using Balanovici_Cristina_Lab2.Models;
using Microsoft.EntityFrameworkCore.Metadata;

namespace Balanovici_Cristina_Lab2.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var book = await _context.Books.Include(m => m.Author)
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,AuthorID,Price")] Book book)
        {
            ...
            PopulateAuthorsList(book.AuthorID);
            return View(book);
        }
        ...
        //lista dropdown
        private void PopulateAuthorsList(object? selectedAuthor = null)
        {
            ...
            ViewBag.AuthorID = new SelectList(authorlist, "ID", "FullName", selectedAuthor);
        }
